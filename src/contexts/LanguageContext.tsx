...
const translations = {
  ...
  availabilityHint: 'Tap a day to enable/disable. Tap times to cycle preset values.',
  onlineStatus: 'Online Status',
  youAreOnline: 'You are currently online',
  youAreOffline: 'You are currently offline',
  applyToRider: 'Apply to Become a Rider',
  applyToRiderDescription: 'Submit an application for approval',
  ...
  availabilityHint: 'Touchez un jour pour activer/désactiver. Touchez les heures pour changer.',
  onlineStatus: 'Statut en Ligne',
  youAreOnline: 'Vous êtes actuellement en ligne',
  youAreOffline: 'Vous êtes actuellement hors ligne',
  applyToRider: 'Postuler comme Livreur',
  applyToRiderDescription: 'Soumettre une candidature pour approbation',
